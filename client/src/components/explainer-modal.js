...
const EXPLAINER_DICTIONARY = {
  ...
  't1': {
    ...
    example: 'Example: 5+ years teaching UG engineering courses with classes of 60 students.'
  },
  't2': {
    ...
    example: 'Example: Using slides for theory, but running weekly lab problem sets for hands-on practice.'
  },
  'interview': {
    ...
    example: 'Example: "Walk me through how you introduce a complex topic in class..."'
  },
  't3': {
    ...
    example: 'Example: Scenario A: Students report high engagement while teacher perceives high difficulty.'
  },
  't4': {
    ...
    example: 'Example: Rating preparation burden as manageable (2/5) while time fit was ideal (4/5).'
  },
  'pes': {
    ...
    example: 'Example: PES 4.2 / 5.0 indicates strong positive student perception.'
  },
  ...
  'active_learning': {
    ...
    example: 'Example: 5-minute think-pair-share exercises during a theory lecture.'
  },
  'direct_instruction': {
    ...
    example: 'Example: Standard 50-minute lecture explaining formula derivations with board work.'
  },
  'guided_instruction': {
    ...
    example: 'Example: Starting a lab exercise with pre-written code skeletons before giving blank files.'
  },
  'peer_instruction': {
    ...
    example: 'Example: Mazur\'s Peer Instruction method with clickers or raised hands.'
  },
  'collaborative_learning': {
    ...
    example: 'Example: Group assignment requiring a joint technical report and presentation.'
  },
  'problem_based_learning': {
    ...
    example: 'Example: "Design a flood-warning sensor network for a river prone to overflowing."'
  },
  'project_based_learning': {
    ...
    example: 'Example: Semester-long capstone project building an autonomous robot.'
  },
  'inquiry_learning': {
    ...
    example: 'Example: Analyzing traffic flow dataset to discover bottlenecks without prior solutions given.'
  },
  'flipped_classroom': {
    ...
    example: 'Example: Reading Chapter 4 before class so class time is spent entirely on problem solving.'
  },
  'reflective_learning': {
    ...
    example: 'Example: Writing a 3-sentence summary of "What was hardest to understand today and why?".'
  },
  ...
  'constraints': {
    ...
    example: 'Example: Teaching 120 students in a tiered lecture hall with fixed desks.'
  }
};
...
export function showExplainerModal(key, customTitle = '', customText = '', triggerEl = null) {
  ...
  const info = EXPLAINER_DICTIONARY[key.toLowerCase()] || {
    title: customTitle || 'Information & Context',
    short: customText || 'Additional details regarding this item.',
    detail: 'This metric or option helps assess pedagogy alignment and student learning experience.',
    example: ''
  };

  const title = customTitle || info.title;
  const short = customText || info.short;
  ...
  modalOverlay.innerHTML = `
    ...
    <div class="explainer-card page-enter">
      ...
      <div class="explainer-body">
        ...
        ${example ? `<div class="explainer-example-box"><strong>💡 Practical Example:</strong> ${example}</div>` : ''}
      </div>
  ...
  // If desktop popover and trigger element provided, position card near trigger
